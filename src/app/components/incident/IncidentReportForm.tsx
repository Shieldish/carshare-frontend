...
const IncidentReportForm: React.FC<IncidentReportFormProps> = ({ bookingId, onReportSuccess }) => {
  ...
  return (
    <>
      ...
      {error && (
        <div className="fixed bottom-6 left-4 right-4 sm:left-auto sm:right-6 z-50 flex items-start gap-3 bg-red-600 text-white px-5 py-4 rounded-xl shadow-2xl animate-in slide-in-from-bottom-4 duration-300 max-w-sm">
